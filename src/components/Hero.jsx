  ...
  return (
    ...
    flex-col xl:px-0 sm:px-16 px-6`}
      ...
      py-[6px] px-4 bg-discount-gradient rounded-[10px] mb-2"
        ...
        >
          <h1
            className="text-white flex-1 font-poppins font-semibold
          ss:text-[72px] text-[52px] ss:leading-[100px]
          leading-[75px]"
          >
        ...
        <p className={`${styles.paragraph} max-w-[470px] mt-5 text-white`}>
          ...
          debitis dolorum quas vel soluta omnis assumenda animi dolor alias
